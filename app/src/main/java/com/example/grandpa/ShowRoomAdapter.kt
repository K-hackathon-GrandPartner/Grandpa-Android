...
class ShowRoomAdapter(val roomList: ArrayList<room_data>) : RecyclerView.Adapter<ShowRoomAdapter.RoomViewHolder>() {
    inner class RoomViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val size_unit = itemView.findViewById<TextView>(R.id.item_sizeUnit) //크기 단위
